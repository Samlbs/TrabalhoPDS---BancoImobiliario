...
//		RepositorioCartas.getInstance().addCarta(card19);
		...
		//apagar essas copias
		Carta saidaLivre1 = new SaidaLivre(20, "Sorte", 0);
		RepositorioCartas.getInstance().addCarta(saidaLivre1);
		Carta saidaLivre2 = new SaidaLivre(20, "Sorte", 0);
		RepositorioCartas.getInstance().addCarta(saidaLivre2);
		Carta saidaLivre3 = new SaidaLivre(20, "Sorte", 0);
		RepositorioCartas.getInstance().addCarta(saidaLivre3);
		Carta saidaLivre4 = new SaidaLivre(20, "Sorte", 0);
		RepositorioCartas.getInstance().addCarta(saidaLivre4);
		Carta saidaLivre5 = new SaidaLivre(20, "Sorte", 0);
		RepositorioCartas.getInstance().addCarta(saidaLivre5);
